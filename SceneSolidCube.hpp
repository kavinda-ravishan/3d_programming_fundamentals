...
class SceneSolidCube : public Scene
{
public:
    SceneSolidCube(const int frame_width, const int frame_height)
        : Scene(frame_width, frame_height, "Solid Cube"), _pc3t(frame_width, frame_height)
    {}

    ~SceneSolidCube() = default;
