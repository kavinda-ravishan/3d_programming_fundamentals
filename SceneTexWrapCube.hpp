...
class SceneTexWrapCube : public Scene
{
public:
    SceneTexWrapCube(const int frame_width, const int frame_height, const std::string texture_path, const float tex_dim)
        :
        Scene(
            frame_width,
            frame_height,
