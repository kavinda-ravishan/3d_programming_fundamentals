...
class SceneFoldedCube : public Scene
{
public:
    SceneFoldedCube(const int frame_width, const int frame_height, const std::string texture_path)
        :
        Scene(
            frame_width,
            frame_height,
